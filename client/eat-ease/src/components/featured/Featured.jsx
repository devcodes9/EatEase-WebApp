...
const Featured = () => {
    const { data, loading, error } = useFetch("/kitchens/countByKitchen?kitchens=Apna Kitchen,Mumma's Best,Khana Khazana")
    console.log(data);
    return (
                            ...
                            <div className="container">
                                <div className="card text-bg-dark mb-3">
                                    ...
                                    <div className="card-img-overlay">
                                        ...
                                        <p className="card-text"><small>{data[0]} Subscribed</small></p>
                                    </div>
                                </div>
                            </div>
                            <div className="container">
                                <div className="card text-bg-dark mb-3">
                                    ...
                                    <div className="card-img-overlay">
                                        ...
                                        <a href="#" className="btn" style={{ backgroundColor: "#DD5642" }}>Subscribe</a>
                                        <p className="card-text"><small>{data[1]} Subscribed</small></p>
                                    </div>
                                </div>
                            </div>
                            <div className="container">
                                <div className="card text-bg-dark mb-3">
                                    ...
                                    <div className="card-img-overlay">
                                        ...
                                        <a href="#" className="btn" style={{ backgroundColor: "#DD5642" }}>Subscribe</a>
                                        <p className="card-text"><small>{data[2]} Subscribed</small></p>
                                    </div>
                                </div>
                            </div>
                        </>
